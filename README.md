...
## Repositories: 
1. <a href="https://github.com/younes-mirinezhad/YOLO">YOLO Codes to train, test and scrips(C++, Qt, Python)</a>
...
6. <a href="https://github.com/younes-mirinezhad/DockerBase_Projects">A simple Dockerised project of AI + Website (AI: Python, Backend: Python, Frontend: HTML, JS)</a>
##  
